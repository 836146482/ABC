    ...
    <script>
        $(function () {
            $('#btnLogin').click(function () {
                if ($('#tbxUserName').val().trim() == "" && $('#tbxPwd').val().trim() == "") {
                    if (typeof ($.cookie('allAmount')) == "undefined")
                        $.cookie('allAmount', '0', { expires:9999, path: '/' });
            ...
            <div class="menu">
                <div class="login">
                    ...
                    <div class="login-button">
                        <asp:Button runat="server" ID="btnLogin"  Text="Login with YellEat" OnClick="btnLogin_OnClick"  />
                    </div>
                    <div class="forget">
