                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button runat="server" ID="btnDelete" CssClass="btn btn-xs btn-danger" Text="删除" CommandName="del" CommandArgument='<%#Eval("ProductID") %>' OnClientClick="return confirm('删除菜单会将相关的订单也删除，是否继续删除？')" />
