    ...
    <table class="input-table">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator runat="server" ID="rev1" ControlToValidate="tbxShopZip" ForeColor="red" ErrorMessage="餐馆邮编格式不正确" ValidationExpression="[1-9]{5}" Display="Dynamic"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td>电话：</td>
