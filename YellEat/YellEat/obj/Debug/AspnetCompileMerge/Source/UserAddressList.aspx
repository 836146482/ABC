...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="eat">
        <span class="address-icon"></span>地址簿　
    </div>
    <asp:UpdatePanel runat="server" ID="updatePanel1">
        <ContentTemplate>
            ...
            <div class="total" style="text-align: center">
                <ul>
                    <li style="width: 50%; text-align: right; padding-right: 20px;"><a id="fancy2" href="#divAdd">添加新地址&nbsp;<img src="images/add.png" /></a></li>
                    <li style="width: 50%; text-align: left; padding-left: 20px;"><a id="fancy1" href="#divUpdate">&nbsp;&nbsp;编辑&nbsp;<img src="images/modify.png" /></a></li>
                </ul>
            </div>
