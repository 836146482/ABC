...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <ItemTemplate>
            <div style="margin: 10px auto; width: 90%;">
                ...
                <div>
                    <asp:Repeater runat="server" ID="rptProduct" OnItemDataBound="rptProduct_OnItemDataBound">
                       ...
                       <%--         <td class="pad0" style="width:90px;" id="<%#Eval("ShopID") %>,<%#Eval("ProductID") %>">--%>
                                    ...
                                    <asp:Label runat="server" ID="lblAmount" CssClass="amount" Text='<%#Eval("Amount")%>'></asp:Label>
                ...
                <p style=" text-align: center;border-bottom:1px #787878 dashed;margin:5px 0;padding:5px 0;">                    
                 <asp:Button runat="server" ID="btnSumit" Text="生成订单" Width="300px" CommandName="order" CommandArgument='<%#Eval("ShopID") %>' CssClass="submitOrder"/>
                </p>
            </div>
        </ItemTemplate>
    </asp:Repeater>
    <script type="text/javascript">
        $(function () {
            var allAmount = $('#cartNum').text().substring(1, $('#cartNum').text().length - 1);
            $(".add").click(function () {
                allAmount++;
